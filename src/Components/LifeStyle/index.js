    ...
    return (
        <div className="main_container column_container lifeStyle_container">
            ...
            <div className="lifeStyle_images">
                <Link className="lifeStyle_image" to="/lifeStyle" onClick={() => props.getCarsByCategory("family")}>
                ...
                <Link className="lifeStyle_image" to="/lifeStyle" onClick={() => props.getCarsByCategory("adventure")}>
                ...
                <Link className="lifeStyle_image" to="/lifeStyle" onClick={() => props.getCarsByCategory("value")}>
