    ...
    <div className="main_container column_container">
        ...
        Cars by Body Type
            ...
            <ul className=" main_container bodytype_images_container">
                <Link to={props.authToken ? "/lifeStyle": "#"}  onClick={() => props.getCarsByBodyType("hatchback")}>
                ...
                <Link to={props.authToken ? "/lifeStyle": "#"}  onClick={() => props.getCarsByBodyType("sedan")}>
                <img className="bodytype_image" src="https://mcmscache.epapr.in/post_images/website_300/post_12645431/5d8d02195e992.jpeg" />
                </Link>
                <Link to={props.authToken ? "/lifeStyle": "#"} onClick={() => props.getCarsByBodyType("SUV")}>
